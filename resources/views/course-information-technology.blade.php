...
@section('title','Information Technology - MCKV Institute of Engineering')
         ...
         <div class="container">
             <div class="row m-0 justify-content-start align-items-end">
              ...
              <div class="col-xl-7 col-lg-7 col-md-8 col-12 mb-sm-0 mb-2 ps-sm-0 pe-sm-3 ps-0 pe-0 ">
               ...
               Information Technology has emerged as one of the most transformative and dynamic fields in the modern world, driving innovation across industries through advancements in Artificial Intelligence, Data Science, Cloud Computing, Cyber security, Internet of Things (IoT), and Digital Transformation. Today, IT professionals are not only employed in software companies but also play vital roles in sectors such as banking, healthcare, insurance, manufacturing, e-commerce, education, and smart infrastructure. As organizations increasingly rely on intelligent and data-driven technologies, the demand for skilled IT professionals continues to grow rapidly. Consequently, Information Technology remains a highly sought-after discipline, attracting talented students with strong interests in engineering, innovation, and emerging technologies.</div> 
                    ...
                    <div class="container-fluid p-0 replica-container">
                        ...
                        <div class="row g-0 align-items-stretch">
                            <div class="col-md-12 d-flex flex-column justify-content-center info-box box-accreditation">
                                ...
                                <div class="box-subtext">[80% students are admitted from WBJEE, 10% from JEE (MAIN), 10% from Management Quota + 6 students are from TFW Quota]</div>
                            </div>
                            
                            <div class="col-md-12 d-flex flex-column justify-content-center info-box box-approval min-vh-0">
                                
                                <div class="box-subtext mt-0">Additional 12 Students can be admitted in 3rd Semester through JELET (Lateral Entry Admission)</div>
                            </div>
                        </div>
                    </div>
...
@include('render-course-enquiry')
 ...
 <section class="package">
  ...
  <img src="{{asset('images/it-course.webp')}}" alt="" class="w-100 prinsiple">
...
<ul>
    ...
    <li>To deliver quality, prompt and reliable technology education services aligning with the Institute’s mission in teaching and learning.</li>
    <li>To engage in emerging research areas and establishing leadership.</li>
    <li>To contribute to the community services at large as well as catering to socio-economic goals in local and national levels.</li>
...
<ul>
 <li><b>PEO1:</b> The graduates of Information Technology program will acquire a strong background in basic & contemporary science and ability to use these tools in Information Technology.</li>
  <li><b>PEO2: </b> The graduates of Information Technology program will demonstrate technical and research competence in various fields of Information Technology and allied areas.</li>  
   <li><b>PEO3: </b> The graduates of Information Technology program will attain professional and entrepreneurial excellence through life-long learning.</li> 
   
   <li><b>PEO4:</b>  The graduates of Information Technology program will imbibe ethical and moral behaviour.</li>
  ...
  <img src="{{asset('images/Programme-Educational-Objective-it.webp')}} " alt="" class="w-100">
...
Information Technology Engineering Graduates will be able to:</br></br>
...
<section class="package">
  ...
  <img src="{{asset('images/it-Programme-Specific-Outcomes.webp')}}" alt="" class="w-100">
...
<ul>
 <li><b>PSO – I:</b> Understand, analyze and develop computer programs for efficient analysis and design of computer-based systems.

</li>
  <li><b>PSO – II:</b> Apply standard practices and strategies in software development.

</li>  
    
  <li><b>PSO – III:</b> Employ modern computer languages, software tools and platforms in creating innovative career paths to be a successful professional.
...
<section class="package">
 ...
 <span class="fs-5 fw-bolder  w-100 mb-3 d-flex red">1. Research and Development
  ...
  <span class="fs-6 fw-bolder  w-100 mb-3 d-flex red">AY : 2021-22</span> 
    
    <ul>
        <li>P. Jana, <b>A. Phadikar</b>, and H. Mandal, “FPGA based implementation of reversible data hiding scheme for content verification and quality access control of image,” International Journal of Signal and Imaging Systems Engineering, vol. 12, no. 3, pp. 93–107, Sep. 2021.
</li>
</ul></br>

 <span class="fs-6 fw-bolder  w-100 mb-3 d-flex red">AY : 2022-23</span>
 
 <ul>
        <li><b>S. Sengupta</b>, A. Dutta, S. A. M. Abdelmohsen, H. A. Alyousef, and M. Rahimi-Gorji, “Development of a rice plant disease classification model in big data environment,” Bioengineering, vol. 9, no. 12, p. 758, 2022, doi: 10.3390/bioengineering 9120758.
...
<div class="row m-0 justify-content-end ">
   <div class="col-lg-2 col-6 px-0"><a href="{{url('/faculty-contributions-it')}}"><div class="readmore_btn mt-sm-2 mt-2 w-100">Read More</div></a></div> 
