...
@section('title','B.Tech in Automobile Engineering - MCKV Institute of Engineering')
     ...
     <div class="mainbody_div">
         ...
         <div class="container">
             <div class="row m-0 justify-content-start align-items-end">
              ...
              A Minor in Electric Vehicles further enhances expertise, preparing students to become skilled, innovative, and industry-ready professionals.</div> 
...
@include('render-course-enquiry')
 ...
 <section class="package">
  ...
  <img src="{{asset('images/IMG_2737.webp?v=1')}}" alt="" class="w-100 prinsiple">
...
<ul>
    ...
    <li>To inculcate enthusiasm, zest and innovativeness of students to work in a team to undertake a complete appropriate project.</li>
    <li>To develop industry attached laboratory so that students will familiarize with emerging industry practices.</li>
    <li>To develop competency for higher studies among students.</li>
...
<ul>
 <li><b>PEO-I:</b> Graduates of the program will have successful industrial and professional career.</li>
  <li><b>PEO-II:</b> Graduates will pursue higher study and research for societal needs.</li>  
   <li><b>PEO-III:</b> Graduates will undergo lifelong learning and adapt technological changes relevant in their domain.</li>  
  ...
  <img src="{{asset('images/SJA_02.webp')}} " alt="" class="w-100">
...
<section class="package">
     ...
     <div class="mainbody_div mainbody_div2 bgcolor1" >
      ...
      <div class="row m-0 justify-content-center">
             ...
             <div class="mainhome_title text-justify mb-sm-4 mb-3">
...
<section class="package">
  ...
  <img src="{{asset('images/SJA_03.webp')}}" alt="" class="w-100">
...
<ul>
 <li><b>PSO – I:</b> Ability to analyse, design, formulate and solve automobile engineering related problems.

</li>
  <li><b>PSO – II:</b> Ability to design, manufacturing and maintenance of various automotive sub systems using software like Auto CAD, CATIA, CREO and facilities including engine testing and performance measurement, vehicle diagnostics, and automotive maintenance practice.
...
<div class="row m-0 justify-content-end ">
   <div class="col-lg-2 col-6 px-0"><a href="{{url('/faculty-contribution-automobile-engineering')}}"><div class="readmore_btn mt-sm-2 mt-2 w-100">Read More</div></a></div> 
