...
<ul>
 <li><b>PEO-I:</b>     Graduates of the programme will be successful computing professionals.</li>
  <li><b>PEO-II:</b>   Graduates of the programme will pursue higher education or continuously update their knowledge through lifelong learning.</li>  
   <li><b>PEO-III:</b> Graduates of the programme will practice their profession by exhibiting effective communication and team work skills.</li>  
...
<ul>
 <li><b>PSO – I:</b> Demonstrate basic knowledge of modern technologies like Cloud Computing, Artificial Intelligence and Machine Learning, Web based application development and relate the idea of hardware and computation for career paths and zest for higher studies.

</li>
  <li><b>PSO – II:</b> Design and develop efficient algorithms for engineering problems related to Database, Computer networks and System software by using suitable data structures and emerging tools for software development.
...
<section class="package">
 ...
 <div class="col-xl-12 col-lg-12 col-md-12 col-12 px-0">
  ...
  <span class="fs-5 fw-bold  w-100 mb-3 d-flex blue">1. Research and Development</span>
   ...
   <span class="fs-5 fw-bolder  w-100 mb-3 d-flex red">Publications (Year 2025-26)</span> 
...
<div class="row m-0 justify-content-end ">
   <div class="col-lg-2 col-6 px-0"><a href="{{url('/faculty-contributions-cse')}}"><div class="readmore_btn mt-sm-2 mt-2 w-100">Read More</div></a></div> 
