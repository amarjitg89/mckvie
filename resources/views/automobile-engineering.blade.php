...
@section('title','Automobile Engineering Department - MCKV Institute of Engineering')
...
@section('content')
     ...
     <div class="mainbody_div">
         ...
         <div class="container">
           ...
           <div class="col-xl-5 col-lg-5 col-md-4 col-12 ps-sm-4 pe-0 ps-0">
            ...
            <img src="{{asset('images/Page Banner_Mobile Version 500x300.jpg .jpeg')}}" class="w-100" alt="...">   
 ...
 <div class="row m-0 justify-content-start ">      
        ...
        As an active member of SAE India, the department encourages students to design and manufacture vehicles for prestigious national-level competitions such as BAJA SAE, eBAJA, SUPRA SAE, SAEINDIA REEV, and EFFICYCLE. Students have consistently achieved recognition and accolades in these events, showcasing their technical and innovative capabilities.</br></br>
         
        Graduates from the department are well placed in leading automotive companies, manufacturing industries, the automotive insurance sector, government organizations, and as successful entrepreneurs in India and abroad. A strong academic foundation, combined with extensive industry exposure, ensures that students are well prepared to meet the evolving demands of the automotive and mobility industry.
         </div>   
           ...
           <div class="col-lg-12 col-md-12 col-12">
              ...
              <div class="mainhome_title text-center mb-2">
                ...
                <span class="fw-normal"> Academic Programs in the </span></br>
                   ...
                   <span class="red">Automobile Engineering</span></div>     
              ...
              <a href="{{url('/course/automobile-engineering')}}"><div class="readmore_maindiv_new"><div class="readmore_btn w-100">View Details</div></div>  </a>    
