                    ...
                    <div class="container-fluid p-0 replica-container">
                        ...
                        <div class="row g-0 align-items-stretch">
                            ...
                            <div class="col-md-12 d-flex flex-column justify-content-center info-box box-approval min-vh-0">
                                ...
                                <div class="box-subtext mt-0">Additional 10% Students can be admitted in 3rd Semester through JELET (Lateral Entry Admission).</div>
                            </div>
                        </div>
                    </div>
...
<ul>
    ...
    <li>To provide the graduates with profound theoretical and practical exposures to bridge the gap between educational theory and industrial practices through collaborative events with industry, laboratory classes and training programmes.</li>
    <li>To instill desire and ability of lifelong learning and professional developments through self study and continuous education to enable the graduates to meet changing societal demands for sustainable development.</li>
    <li>To build improved team building, team working, communication and leadership skills with high regard to ethical values.</li>
...
<ul>
 <li><b>PEO1:</b>  	The Graduates of Mechanical Engineering Programme will develop solution of complex engineering problems related to the society in their profession and career.</li>
  <li><b>PEO2: </b> The Graduates of Mechanical Engineering Programme will pursue continuing education.</li>  
   <li><b>PEO3: </b>  	The Graduates of Mechanical Engineering Programme will demonstrate and exemplify team work and ethical practices in their career.</li> 
...
<ul>
 <li><b>PSO – I:</b> Ability to analyse and design physical systems and components using AUTOCAD, CATIA and ANSYS etc. software.

</li>
  <li><b>PSO – II:</b> To work professionally in manufacturing, design, thermal engineering and software industries.
...
<section class="package">
 ...
 <span class="fs-5 fw-bolder  w-100 mb-3 d-flex red">1. Research and Development
   ...
   <span class="fs-5 fw-bolder  w-100 mb-3 d-flex red">Publications </span> 
    ...
    <ul>
        <li>S. Bose, N. Bose, and M. Chowdhury, “A Correlative Approach on Machining Characteristics by WEDM Using an Innovative Desirable Ant Colony Optimization Algorithm,” National Academy Science Letters, Mar., pp. 1-7, 2026.


</li>
        
        <li>S. Bose, “Comparative Performance Analysis on WEDM Responses for Titanium Matrix Composite Using Novel Multi-objective Optimization Algorithms,” National Academy Science Letters, vol. 48, no. 2, Apr., pp. 251-257, 2025.
</li>
        
        <li>S. Bose, “Novel statistical investigation on performance measures of WEDM: Optimization, microstructure and mechanical properties,” Proceedings of the Institution of Mechanical Engineers, Part C: Journal of Mechanical Engineering Science, vol. 238, no. 24, Dec., pp. 11139–11158, 2024.
</li>

<li>S. Bose, and T. Nandi, “Proximate analysis on WEDM performances for titanium matrix composite using a novel desirable multi-objective genetic algorithm,” Sādhanā, vol. 49, no. 2, Apr., pp. 1-13. 2024.
</li>
...
<div class="row m-0 justify-content-end ">
   <div class="col-lg-2 col-6 px-0"><a href="{{url('/faculty-contributions-me')}}"><div class="readmore_btn mt-sm-2 mt-2 w-100">Read More</div></a></div> 
