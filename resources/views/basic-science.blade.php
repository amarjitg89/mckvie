...
@section('content')
     ...
     <div class="mainbody_div">
         ...
         <div class="container">
           ...
           <div class="col-xl-5 col-lg-5 col-md-4 col-12 ps-sm-4 pe-0 ps-0">
            ...
            <img src="{{asset('images/Department-Overview-basic-science.webp')}}" class="w-100" alt="...">   
 ...
 <div class="row m-0 justify-content-start ">      
       ...
       Communication skills as a part of the overall program create a teaching learning process to make the students grasp the role of Soft Skills in a global environment. The department pays individual attention to ensure that students are ready to face dynamic professional spheres through group discussions and mock interview sessions. Project Presentations and use of Audio-Visual equipment to facilitate a better understanding of the dynamics of interaction are stressed upon.</br></br>
       
       In essence, the department stands as a pillar of foundational knowledge and scholarly pursuits, dedicated to blear the boundary between Science and Engineering, poised to make significant contributions to society’s ever-expanding pool of knowledge and innovation.    
        </div>     
...
<ul>
    ...
    <li>To imbibe value education and foster holistic skill development among students.</li>
    <li>To elevate departmental research activities and encourage faculty knowledge upgradation.</li>
           ...
           <div class="col-lg-12 col-md-12 col-12">
              ...
              <div class="mainhome_title text-center mb-2">
                ...
                <span class="fw-normal"> Academic Programs in the </span></br>
                   ...
                   <span class="red">Basic Science & Humanities</span></div>     
              ...
              <div class="row m-0 mt-4 mb-3" >
               ...
               <div class="row m-0 p-0 align-items-center align-items-md-start  justify-content-start">
                   <div class="col-xl-4 col-lg-3 col-sm-4 col-12 p-0"> <img src="{{asset('images/course/basic-science-course.webp')}}" class="eventimg_css" alt="..."></div>
            ...
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since 1966, when designers at Letraset and James Mosley, the librarian at St Bride Printing Library, took a 1914 Cicero translation and scrambled it to make dummy text for Letraset's Body Type sheets. It has survived not only many decades, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised thanks to these sheets and more recently with desktop publishing software including versions of Lorem Ipsum.
              ...
              <a href="{{url('/course/basic-science-and-humanities')}}"><div class="readmore_maindiv_new"><div class="readmore_btn w-100">View Details</div></div>  </a>    
...
I invite all students to make the best use of the resources and opportunities provided by the department.A strong grasp of fundamentals today will empower you to innovate tomorrow.</br></br>

Wishing you a successful and enriching academic journey.
